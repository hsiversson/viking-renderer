...
namespace vkr
{
	...
	static const Mat33 CAT_D60_to_D65 = 
	{
	...
	static const Mat33 CAT_D65_to_D60 = 
	{
	...
	const ColorGamut ColorGamut::ACEScg =
	{
		...
		CAT_D60_to_D65 * AP1_TO_XYZ,
		XYZ_TO_AP1 * CAT_D65_to_D60,
	...
	{
		const Mat33 transform = targetGamut.m_XYZToRGB * sourceGamut.m_RGBToXYZ;
