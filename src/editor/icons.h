...
namespace vkr::Editor
{
	enum IconType : uint8_t
	{
		...
		EDITOR_ICON_LEFT_ARROW_WHITE,
		EDITOR_ICON_UP_ARROW_WHITE,
		EDITOR_ICON_RIGHT_ARROW_WHITE,
		EDITOR_ICON_DOWN_ARROW_WHITE,
		...
		EDITOR_ICON_PLAY_WHITE,

		EDITOR_ICON_VISIBLE_WHITE,
		EDITOR_ICON_NOT_VISIBLE_WHITE,
